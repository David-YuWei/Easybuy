...
<body>
    <div class="container">
		...
		<div class="registrationtop"></div>
			<form id="form" method="post" action="/Easybuy/registration/seller/add">
				<div class="registration-form">
					...
					<div class="form-row">
						...
						<input name="firstname" id="firstname" type="text" value="${firstname}" class="input-text" id="inputSuccess"/>&nbsp;<font color="red">*</font>
					</div>
					<div class="form-row">
					...
					<div class="form-row">
						...
						<input name="accountnumber" id="accountnumber" type="accountnumber" value="${accountnumber}" class="input-text"/>&nbsp;<font color="red">*</font>
					</div>
					<div class="form-row">
						<label>Routing Number</label>
						<input name="routingnumber" id="routingnumber" type="routingnumber" value="${routingnumber}" class="input-text"/>&nbsp;<font color="red">*</font>
					</div>
					<div class="form-row">
