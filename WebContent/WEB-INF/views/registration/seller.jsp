			...
			<form id="form" method="post" action="/Easybuy/registration/seller/add">
				<div class="registration-form">
					...
					<div class="form-row">
						...
						<div class="input-box"><input name="accountnumber" id="accountnumber" type="accountnumber" value="${accountnumber}" class="input-text"/>&nbsp;<font color="red">*</font></div>
					</div>
					<div class="form-row">
						<div class="label">Routing Number</div>
						<div class="input-box"><input name="routingnumber" id="routingnumber" type="routingnumber" value="${routingnumber}" class="input-text"/>&nbsp;<font color="red">*</font></div>
					</div>
