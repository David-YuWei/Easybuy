			...
			<div class="productForm">
				<form id="form" enctype="multipart/form-data" name="form" method="post" action="/Easybuy/product/add">
					...
					<div class="input-row">
						...
						<div class="input-box"><input name="price" id="price" onkeyup="if(!this.value.match(/^[\+\-]?\d*?\.?\d*?$/))this.value=this.t_value;else this.t_value=this.value;if(this.value.match(/^(?:[\+\-]?\d+(?:\.\d+)?)?$/))this.o_value=this.value"  type="text" value="<%= price%>" class="input-text"/>&nbsp;<font color="red">*</font></div>
					</div>
					<div class="input-row">
